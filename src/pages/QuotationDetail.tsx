    ...
    <div>
        ...
        <div className="flex items-center gap-3">
          {quotation.status !== 'converted' && (
            <button
              ...
              disabled={converting}
              className="rounded-xl border border-slate-200 px-4 py-2 text-sm font-medium text-slate-700 transition-colors hover:border-slate-300 hover:bg-slate-50 disabled:opacity-50"
            >
      ...
      <div className="rounded-2xl bg-white p-8 shadow-[0_1px_2px_rgba(15,23,42,0.04),0_12px_24px_-16px_rgba(15,23,42,0.12)] print:shadow-none">
        <div className="mb-8 flex flex-wrap items-start justify-between gap-4 border-b border-slate-100 pb-6">
          <div>
            <p className="text-lg font-semibold text-slate-900">{tenantName || 'Quotation'}</p>
